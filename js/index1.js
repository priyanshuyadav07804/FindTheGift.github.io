...
function loading() {
    ...
    let B0 = document.getElementById("img4");
    let B1 = document.getElementById("img5");
    let B2 = document.getElementById("img6");
    let C0 = document.getElementById("img7");
    let C1 = document.getElementById("img8");
    let C2 = document.getElementById("img9");
    ...
    let countp = 0;
    let pw = 0;
    const arrayOfLetters = [A0, A1, A2, B0, B1, B2, C0, C1, C2];
    ...
    const bombi = Math.floor(Math.random() * 9);
    ...
    const gi1 = Math.floor(Math.random() * 8);
    ...
    const gi2 = Math.floor(Math.random() * 7);
    ...
    const gi3 = Math.floor(Math.random() * 6);
